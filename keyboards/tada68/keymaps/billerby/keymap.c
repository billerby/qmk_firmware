...
//  |    Tab     |    Q   |    W   |    E   |    R   |    T   |    Y   |    U   |    I   |    O   |    P   |    Å   |    ¨   |            |  End   |
     KC_TAB , KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    SE_ARNG, SE_UML,              KC_END,
//  |--------------------------------------------------------------------------------------------------------------------------|          |--------|
//  |   Caps Lock|    A   |    S   |    D   |    F   |    G   |    H   |    J   |    K   |    L   |   Ö    |   Ä    |   '    |   Enter    |  PgUp  |
        KC_CAPS,     KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   SE_OUML, SE_AUML, SE_QUT,    KC_ENT,  KC_PGUP,
//  |----------------------------------------------------------------------------------------------------------------------------------------------|
...
//  |----------------------------------------------------------------------------------------------------------------------------------------------|
//  |  LCtrl   |   Win   | Command  |                        Space                          |Ralt    |  Fn  |  RCtrl    |  Left  |  Down  | Right  |
